...
--
-- Each section has a *type-this / see-that* note. The plugin's own lua/ dir is put on
-- the runtimepath by the launcher; here we just configure it.
...
nx.complete.setup({
  sources = { { "buffer", min_chars = 3 }, { "nxsnippets", min_chars = 2 } },
})
