#!/usr/bin/env bash
#
# Generate doc/bemtvi-snippets.txt (the vimdoc help file) from
# doc/bemtvi-snippets.md using panvimdoc <https://github.com/kdheepak/panvimdoc>
...
# file is never hand-aligned. Edit doc/bemtvi-snippets.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="bemtvi-snippets"                    # → :help bemtvi-snippets
DESCRIPTION="A snippet engine for bemtvi"    # header tagline (line 1)
# -----------------------------------------------------------------------------
