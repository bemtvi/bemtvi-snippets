#!/usr/bin/env bash
#
# Generate doc/nxvim-snippets.txt (the vimdoc help file) from
# doc/nxvim-snippets.md using panvimdoc <https://github.com/kdheepak/panvimdoc>
...
# file is never hand-aligned. Edit doc/nxvim-snippets.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="nxvim-snippets"                    # → :help nxvim-snippets
DESCRIPTION="A snippet engine for nxvim"    # header tagline (line 1)
# -----------------------------------------------------------------------------
